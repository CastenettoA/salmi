...
export default {
  ...
  created: function(){
    this.scrollToTop();
    document.title = ' Le parole più frequenti nel Salterio';
    document.getElementsByTagName('meta')["description"].content = 'Elenco della parole utilizzare più di frequente all\'interno del Salterio.';
  },
